...
public class Vague {
	//CASEX et CASEY SONT INVERSé : EN REALITé CASEX EQUIVANT A LA CASE Y (trop facile sinon)!
	@SuppressWarnings("unused")
	private int nb;
	private int nbMax=30;
	private HashMap<Integer, ArrayList<Monstre>> vague;
	//Départ de la vague pour créer les monstre dans la arraylist.
	private int caseX = 0;
	private int caseY = 0;
