...
public class EcranJeu implements Screen, InputProcessor {
    ...
    public void AvancerMonstre(){
    	for (int i=0 ; i < TabMonstre.size();i++){
    			if(!T.TabCase[TabMonstre.get(i).getIndexCaseH()][TabMonstre.get(i).getIndexCaseL()+1].isVide()){
    				...
    				if(T.getNbCaseLong()-1 != TabMonstre.get(i).getIndexCaseL()){
        				TabMonstre.get(i).setIndexCaseH(TabMonstre.get(i).getIndexCaseH()+1);
        				}
    			}
    			//if(T.getNbCaseLong()-1 != TabMonstre.get(i).getIndexCaseL()){
					//TabMonstre.get(i).setIndexCaseL(TabMonstre.get(i).getIndexCaseL()+1);
    				...
    				if (TabMonstre.get(j).getKey() == temp ){
    					...
    					if(TabTour.get(i).getIndexCaseH()-2 <= TabMonstre.get(j).getIndexCaseH() && TabTour.get(i).getIndexCaseH()+2 >= TabMonstre.get(j).getIndexCaseH()){
    						if(TabTour.get(i).getIndexCaseL()-2 <= TabMonstre.get(j).getIndexCaseL() && TabTour.get(i).getIndexCaseL()+2 >= TabMonstre.get(j).getIndexCaseL()){ 
    							...
    							for (int j1=0 ; j < TabMonstre.size();j++){
    								if(!TabTour.get(i).isAttaqueEnCour()){
    									if(TabTour.get(i).getIndexCaseH()-2 <= TabMonstre.get(j1).getIndexCaseH() && TabTour.get(i).getIndexCaseH()+2 >= TabMonstre.get(j1).getIndexCaseH()){
    										if(TabTour.get(i).getIndexCaseL()-2 <= TabMonstre.get(j1).getIndexCaseL() && TabTour.get(i).getIndexCaseL()+2 >= TabMonstre.get(j1).getIndexCaseL()){  
    											if(TabMonstre.get(j1).getPointdevie()-TabTour.get(i).getDmg() > 0){						
    												TabMonstre.get(j1).setPointdevie(TabMonstre.get(j1).getPointdevie()-TabTour.get(i).getDmg());
    												TabTour.get(i).setCible(TabMonstre.get(j1).getKey());
    												TabTour.get(i).setAttaqueEnCour(true);
    												System.out.println("ATTAQUE1REATACK "+ TabMonstre.get(j1).getPointdevie()+" / "+TabMonstre.get(j1).getKey()+" / "+TabTour.get(i).getCible());
    											}
    											else{
    												for(int ab = 0 ; ab < TabTour.size() ; ab++){
    													if(TabTour.get(ab).getCible() == TabMonstre.get(j1).getKey()){
    														TabTour.get(ab).setAttaqueEnCour(false);
    													}
    												}
    												System.out.println("ATTAQUE1REATACK et destru "+ TabMonstre.get(j1).getPointdevie()+" / "+TabMonstre.get(j1).getKey()+" / "+TabTour.get(i).getCible());
    												TabTour.get(i).setAttaqueEnCour(false);
    												P.setSous(P.getSous()+TabMonstre.get(j1).getPrix());
    												TabMonstre.remove(j1);
    											}				
    										}
    										else{			
    										}
